...
from emdad.addons.mail_group.tests.data import GROUP_TEMPLATE
from emdad.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('emdad.models.unlink', 'emdad.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('emdad.addons.base.models.ir_rule', 'emdad.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.addons.mail_group.models.mail_group_message', 'emdad.models.unlink')
    @users('employee')
    ...
    @mute_logger('emdad.addons.mail_group.models.mail_group')
    @users('employee')
