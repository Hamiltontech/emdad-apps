...
from emdad.tools import config, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, pycompat
...
class ImportMapping(models.Model):
    ...
    not match emdad's field names or labels. This model is used
    ...
    def get_fields_tree(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: name: str
                ...
                The field's logical (emdad) name within the scope of
                its parent.
            ...
            .. attribute:: model_name: str
                ...
                Used in the emdad Field Tooltip on the import view
