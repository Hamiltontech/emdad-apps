...
from emdad.exceptions import UserError, AccessDenied
from emdad.tools import float_is_zero, pycompat
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but emdad has the label on the account.move.line, so that's a
        # problem !
