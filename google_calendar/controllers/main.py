...
from emdad.addons.calendar.controllers.main import CalendarController
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize emdad
            ...
            The dictionary may contains an url, to allow emdad Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted emdad to access his calendar !
