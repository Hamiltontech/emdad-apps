...
export class MessagingMenu extends Component {
    ...
    get installationRequest() {
        return {
            body: _t("Come here often? Install emdad on your device!"),
            displayName: _t("%s has a suggestion", this.store.emdadbot.name),
            onClick: () => {
                this.installPrompt.show();
            },
            iconSrc: this.threadService.avatarUrl(this.store.emdadbot),
            partner: this.store.emdadbot,
    ...
    get notificationRequest() {
        return {
            ...
            displayName: _t("%s has a request", this.store.emdadbot.name),
            iconSrc: this.threadService.avatarUrl(this.store.emdadbot),
            partner: this.store.emdadbot,
            isShown:
                this.store.discuss.activeTab === "main" &&
