    ...
    setup() {
        ...
        this.env.bus.addEventListener(
            ...
            ({ detail: { channel, message } }) => {
                ...
                if (channel.correspondent?.eq(this.store.emdadbot) && this.store.emdadbotOnboarding) {
                    // this cancels emdadbot onboarding auto-opening of chat window
                    this.store.emdadbotOnboarding = false;
                    return;
                }
