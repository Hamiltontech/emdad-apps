...
from emdad.addons.base.models.res_users import Users
from emdad.addons.mail.tests.common import MailCommon, mail_new_test_user
...
class TestUser(MailCommon):
    ...
    def test_notification_type_constraint(self):
        with self.assertRaises(IntegrityError, msg='Portal user can not receive notification in emdad'):
            mail_new_test_user(
                self.env,
