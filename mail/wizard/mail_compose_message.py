...
from emdad import _, api, fields, models, tools, Command
from emdad.exceptions import UserError, ValidationError
from emdad.osv import expression
from emdad.tools import is_html_empty
from emdad.addons.mail.tools.parser import parse_res_ids
...
class MailComposer(models.TransientModel):
    ...
    auto_delete = fields.Boolean(
        ...
        help='This option permanently removes any track of email after it\'s been sent, including from the Technical menu in the Settings, in order to preserve storage space of your emdad database.')
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an emdad domain (list of leaves) """
        self.ensure_one()
