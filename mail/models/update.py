...
from emdad import api, release, SUPERUSER_ID
from emdad.exceptions import UserError
from emdad.models import AbstractModel
from emdad.tools.translate import _
from emdad.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to emdad's publisher warranty server to check the
