...
from emdad import _, api, Command, fields, models, modules, tools
...
class Users(models.Model):
    ...
    def _init_messaging(self):
        ...
        values = {
            ...
            'emdadbot': emdadbot.sudo().mail_partner_format().get(emdadbot),
