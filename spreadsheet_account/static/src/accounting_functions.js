...
functionRegistry.add("emdad.CREDIT", {
...
functionRegistry.add("emdad.DEBIT", {
...
functionRegistry.add("emdad.BALANCE", {
...
functionRegistry.add("emdad.FISCALYEAR.START", {
    description: _t(
...
functionRegistry.add("emdad.FISCALYEAR.END", {
...
functionRegistry.add("emdad.ACCOUNT.GROUP", {
