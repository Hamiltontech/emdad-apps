...
from emdad.addons.website_slides.tests import common
from emdad.exceptions import ValidationError
from emdad.tests import HttpCase
...
class TestResources(common.SlidesCase, HttpCase):
    ...
    def test_download_file_name_extension(self):
        ...
        resource = self.env["slide.slide.resource"].create({
            ...
            'file_name': 'test.png',
            'resource_type': 'file',
            # A file for which _emdad_guess_mimetype and python_magic can detect the mime type: a png file
