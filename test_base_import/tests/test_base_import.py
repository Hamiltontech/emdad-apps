...
from emdad.tests.common import TransactionCase, can_import, RecordCapturer
from emdad.tools import mute_logger, pycompat
from emdad.tools.misc import file_open
from emdad.addons.base_import.models.base_import import ImportValidationError
from emdad.addons.test_base_import.models.test_base_import import model as base_import_model
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('emdad.addons.base_import.models.base_import')
