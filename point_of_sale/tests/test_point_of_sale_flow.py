...
import emdad
from emdad import fields, tools
from emdad.tools import float_compare, mute_logger, test_reports
from emdad.tests.common import Form
from emdad.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('emdad.addons.point_of_sale.models.pos_order'):
