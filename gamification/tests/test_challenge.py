...
from emdad.addons.gamification.tests.common import TransactionCaseGamification
...
class test_challenge(TestGamificationCommon):
    ...
    @mute_logger('emdad.models.unlink', 'emdad.addons.mail', 'emdad.addons.auth_signup')
