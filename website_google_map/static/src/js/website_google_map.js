...
function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('emdad-google-map'), {
        zoom: 1,
    ...
    if (emdad_partner_data){ /* emdad_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < emdad_partner_data.counter; i++) {
            set_marker(emdad_partner_data.partners[i]);
        }
