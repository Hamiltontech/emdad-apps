from emdad import api, models, fields, _
from emdad.exceptions import UserError
from emdad.tools import index_exists
from .account_edi_proxy_auth import emdadEdiProxyAuth
    ...
    def _make_request(self, url, params=False):
        ...
        try:
            response = requests.post(
                ...
                auth=emdadEdiProxyAuth(user=self)).json()
