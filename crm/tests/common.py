...
from emdad.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from emdad.addons.mail.tests.common import MailCase, mail_new_test_user
from emdad.addons.phone_validation.tools import phone_validation
from emdad.addons.sales_team.tests.common import TestSalesCommon
from emdad.fields import Datetime
from emdad import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('emdad.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
