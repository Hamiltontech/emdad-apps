...
from emdad.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('emdad.models.unlink', 'emdad.addons.crm.models.crm_team', 'emdad.addons.crm.models.crm_team_member')
    def test_assign_perf_duplicates(self):
        ...
        with self.with_user('user_sales_manager'):
            ...
            with self.assertQueryCount(user_sales_manager=1167):  # crm 1160 / com 1165
    ...
    def test_assign_perf_no_duplicates(self):
        ...
        # randomness: at least 1 query
        with self.with_user('user_sales_manager'):
            with self.assertQueryCount(user_sales_manager=585):  # crm 582
                self.env['crm.team'].browse(self.sales_teams.ids)._action_assign_leads(work_days=2)
