...
from emdad.addons.base.tests.test_format_address_mixin import FormatAddressCase
from emdad.addons.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from emdad.addons.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from emdad.addons.mail.tests.mail_tracking_duration_mixin_case import MailTrackingDurationMixinCase
from emdad.addons.phone_validation.tools.phone_validation import phone_format
from emdad.exceptions import UserError
from emdad.tests.common import Form, tagged, users
