...
from emdad.addons.crm.tests.common import TestCrmCommon
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@emdad.com', 'fp@emdad.com'),
            ('fp.alias@mail.emdad.com', 'fp.alias@mail.emdad.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.emdad.com', 'subdomain.emdad.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@emdad.COM>',
                'name': 'Dupe1 of fp@emdad.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@emdad.com',
                'name': 'Dupe2 of fp@emdad.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.emdad.com',
                'name': 'Dupe3 of fp@emdad.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                ...
                'name': 'Dupe4 of fp@emdad.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@emdad.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@emdad.com (same commercial entity)',
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@emdad.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@emdad.com')
