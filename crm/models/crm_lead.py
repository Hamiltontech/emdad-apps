...
from emdad import api, fields, models, tools, SUPERUSER_ID
from emdad.addons.iap.tools import iap_tools
from emdad.addons.mail.tools import mail_validation
...
from emdad.tools import date_utils, email_split, is_html_empty, groupby, parse_contact_from_email
...
PLS_COMPUTE_BATCH_STEP = 50000  # emdad.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
