...
from emdad.addons.sale_product_configurator.tests.common import TestProductConfiguratorCommon
from emdad.addons.base.tests.common import HttpCaseWithUserPortal, HttpCaseWithUserDemo
