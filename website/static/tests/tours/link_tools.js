...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Label value should contain emdad.com",
        trigger: '#o_link_dialog_label_input',
        run: () => {
            if ($('#o_link_dialog_label_input').val() !== 'emdad.com') {
                throw new Error('Label value should contain emdad.com');
            }
        },
    },
    {
    ...
    {
        content: "Label value should contain emdad website",
        trigger: '#o_link_dialog_label_input',
        run: () => {
            if ($('#o_link_dialog_label_input').val() !== 'emdad website') {
                throw new Error('Label value should contain emdad website');
            }
        },
    },
    {
