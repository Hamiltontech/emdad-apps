 ...
 * corner to provide the authenticated user an access to his emdad backend.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!window.frameElement) {
        ...
        // - Having an event that's fire only when the page is from emdad avoids
        //   weird behaviours. (e.g. if we want to clear out the iframe, it might
        //   fire an DOMContentLoaded on a non emdad page)
        window.frameElement.dispatchEvent(new CustomEvent('emdadFrameContentLoaded'));
    }
});
