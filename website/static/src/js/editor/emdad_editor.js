...
/**
 * The goal of this patch is to correctly handle emdadEditor's behaviour for text
 * highlight elements.
 */
patch(emdadEditor.prototype, {
    /**
     * @override
     */
    _onClipboardCopy(e) {
        ...
        if (firstChild && firstChild.className && firstChild.className.includes("o_text_highlight_item")) {
            ...
            e.clipboardData.setData("text/emdad-editor", html);
        }
    },
    /**
     * @override
