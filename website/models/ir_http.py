...
from emdad.osv.expression import FALSE_DOMAIN
from emdad.addons.http_routing.models import ir_http
from emdad.addons.http_routing.models.ir_http import _guess_mimetype
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(emdad.conf.server_wide_modules)
