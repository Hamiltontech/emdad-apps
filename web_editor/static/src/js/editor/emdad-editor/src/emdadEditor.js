...
export class emdadEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as emdad-editor utils to avoid this
        ...
        this.editable.classList.add("emdad-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const emdadHtml = dataHtmlElement.innerHTML;
        const emdadText = selection.toString();
        clipboardEvent.clipboardData.setData('text/plain', emdadText);
        clipboardEvent.clipboardData.setData('text/html', emdadHtml);
        clipboardEvent.clipboardData.setData('text/emdad-editor', emdadHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('emdad-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const emdadEditorHtml = ev.clipboardData.getData('text/emdad-editor');
        ...
        if (emdadEditorHtml && targetSupportsHtmlContent) {
            const fragment = parseHTML(this.document, emdadEditorHtml);
