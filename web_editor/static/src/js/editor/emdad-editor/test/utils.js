...
import { emdadEditor } from '../src/emdadEditor.js';
...
export async function testEditor(Editor = emdadEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteemdadEditorHtml = async (editor, html) => pasteData(editor, html, 'text/emdad-editor');
...
export class BasicEditor extends emdadEditor {}
