...
import { emdadEditor, parseHTML, setSelection } from '../../src/emdadEditor.js';
import {
    insertCharsAt,
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        emdadEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new emdadEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    emdadEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
