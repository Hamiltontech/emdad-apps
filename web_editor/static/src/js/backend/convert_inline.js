...
import { getAdjacentPreviousSiblings, isBlock, rgbToHex, commonParentGet } from '../editor/emdad-editor/src/utils/utils';
...
export async function toInline($editable, cssRules, $iframe) {
    $editable.removeClass('emdad-editor-editable');
    const editable = $editable.get(0);
    ...
    $editable.addClass('emdad-editor-editable');
}
/**
...
function fontToImg($editable) {
    const editable = $editable.get(0);
    const { fonts } = emdad.loader.modules.get("@web_editor/js/wysiwyg/fonts");
