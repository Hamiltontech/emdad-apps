...
import { deduceURLfromText } from "@web_editor/js/editor/emdad-editor/src/utils/sanitize";

const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = emdadEditorLib;
...
export class Link extends Component {
    ...
    async _updateState(props) {
        ...
        if (this.state.range) {
            this.$link = this.$link || $(emdadEditorLib.getInSelection(this.editable.ownerDocument, 'a'));
