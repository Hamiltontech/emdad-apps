...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.emdadEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start();
        params.wysiwyg?.emdadEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        .on('show.bs.popover.link_popover', () => {
            this.wysiwyg.emdadEditor.observerUnactive('show.bs.popover');
            this._loadAsyncLinkPreview();
            popoverShown = true;
        })
        .on('inserted.bs.popover', () => {
            this.wysiwyg.emdadEditor.observerActive('show.bs.popover');
        })
        .on('hide.bs.popover.link_popover', () => {
            this.wysiwyg.emdadEditor.observerUnactive('hide.bs.popover');
            popoverShown = false;
        })
        .on('hidden.bs.popover.link_popover', () => {
            this.wysiwyg.emdadEditor.observerActive('hide.bs.popover');
        ...
        if (document !== this.wysiwyg.emdadEditor.document) {
            $(this.wysiwyg.emdadEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.emdadEditor.document).off('.link_popover');
