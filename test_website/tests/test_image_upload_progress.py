...
from emdad.addons.web_editor.controllers.main import Web_Editor
from emdad.addons.web_unsplash.controllers.main import Web_Unsplash
...
class TestImageUploadProgress(emdad.tests.HttpCase):
