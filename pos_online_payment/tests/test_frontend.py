...
from emdad import tools, Command, fields
from emdad.addons.account.tests.common import AccountTestInvoicingCommon
from emdad.addons.pos_online_payment.models.pos_order import PosOrder
from emdad.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from emdad.addons.account.models.account_payment_method import AccountPaymentMethod
from emdad.osv.expression import AND
from emdad.addons.point_of_sale.tests.common import archive_products
