...
from emdad import exceptions, Command, fields
from emdad.tests import Form
from emdad.addons.mrp.tests.common import TestMrpCommon
from emdad.tools import float_compare, float_round, float_repr
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see emdad/addons/web/controllers/main.py:1352)
