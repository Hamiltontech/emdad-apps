...
from emdad import _, fields, models, service
from emdad.exceptions import ValidationError

from emdad.addons.payment_mollie import const
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        emdad_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'emdad/{emdad_version} MollieNativeemdad/{module_version}',
        }
