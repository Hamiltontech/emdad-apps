...
from emdad.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from emdad.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'emdad.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
