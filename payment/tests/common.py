...
from emdad.tools.misc import hmac as hmac_tool

from emdad.addons.base.tests.common import BaseCommon
...
class PaymentCommon(BaseCommon):
    ...
    def setUp(self):
        ...
        if self.account_payment_installed and self.enable_reconcile_after_done_patcher:
            ...
            self.reconcile_after_done_patcher = patch(
                'emdad.addons.account_payment.models.payment_transaction.PaymentTransaction._reconcile_after_done',
            )
    ...
    def _generate_test_access_token(self, *values):
        ...
        environment of emdad.http.request.
