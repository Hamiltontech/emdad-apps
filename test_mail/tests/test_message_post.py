...
from emdad.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from emdad.addons.test_mail.models.test_mail_models import MailTestSimple
from emdad.addons.test_mail.tests.common import TestRecipients
from emdad.api import call_kw
from emdad.exceptions import AccessError
from emdad.tests import tagged
from emdad.tools import mute_logger, formataddr
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.models.unlink', 'emdad.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. emdadbot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-emdad-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.tests')
    ...
    @users('employee')
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.addons.mail.models.mail_message_schedule', 'emdad.models.unlink')
    ...
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('emdad.addons.base.models.ir_model', 'emdad.addons.mail.models.mail_mail')
    ...
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.addons.mail.models.mail_thread')
    @users('employee')
