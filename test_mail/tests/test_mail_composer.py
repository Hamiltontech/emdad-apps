...
from emdad.addons.mail.wizard.mail_compose_message import MailComposer
from emdad.addons.test_mail.models.test_mail_models import MailTestTicket
from emdad.addons.test_mail.tests.common import TestRecipients
from emdad.fields import Datetime as FieldDatetime
from emdad.exceptions import AccessError
from emdad.tests import tagged
from emdad.tests.common import users, Form
from emdad.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('emdad.tests', 'emdad.addons.mail.models.mail_mail', 'emdad.models.unlink')
    ...
    @mute_logger('emdad.tests', 'emdad.addons.base.models.ir_rule', 'emdad.addons.mail.models.mail_mail', 'emdad.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('emdad.models.unlink', 'emdad.addons.mail.models.mail_mail', 'emdad.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('emdad.models.unlink', 'emdad.addons.mail.models.mail_mail')
