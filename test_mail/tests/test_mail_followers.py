...
from emdad.addons.mail.models.mail_mail import _UNFOLLOW_REGEX
...
from emdad.tools import mute_logger, email_normalize, parse_contact_from_email
...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('emdad.addons.base.models', 'emdad.addons.mail.controllers.mail', 'emdad.http', 'emdad.models')
    ...
    @mute_logger('emdad.addons.mail.controllers.mail', 'emdad.models', 'emdad.http')
