...
from emdad.tools import is_html_empty, mute_logger, formataddr
...
class TestMessageAccess(MailCommon):
    ...
    @mute_logger('emdad.addons.base.models.ir_model', 'emdad.addons.base.models.ir_rule')
    ...
    def test_mail_message_access_create_wo_parent_access(self):
        ...
        partner_1 = self.env['res.partner'].create({
            'name': 'Jitendra Prajapati (jpr-emdad)',
            'email': 'jpr@emdad.com',
        })
