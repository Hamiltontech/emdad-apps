...
from emdad import fields, exceptions, tests
from emdad.addons.mail.tests.common import mail_new_test_user, MailCommon
from emdad.addons.test_mail.models.test_mail_models import MailTestActivity
from emdad.tools import mute_logger
from emdad.tests.common import Form, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('emdad.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('emdad.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('emdad.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
