...
from emdad.addons.mail.models.mail_thread import MailThread
from emdad.addons.mail.tests.common import mail_new_test_user, MailCommon
from emdad.addons.test_mail.data import test_mail_data
from emdad.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from emdad.addons.test_mail.models.test_mail_models import MailTestGateway
from emdad.sql_db import Cursor
from emdad.tests import tagged
from emdad.tools import email_split_and_format, formataddr, mute_logger
...
class TestEmailParsing(MailCommon):
    ...
    def test_message_parse_and_replace_binary_octetstream(self):
        ...
        with self.assertLogs('emdad.addons.mail.models.mail_thread', level="WARNING") as capture:
        ...
        self.assertEqual(capture.output, [
            ("WARNING:emdad.addons.mail.models.mail_thread:Message containing an unexpected "
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.emdad.com (Mail Delivery System)',
            email_to='bounce@xxx.emdad.com',
            delivered_to='bounce@xxx.emdad.com'
        )
...
class TestMailgateway(MailCommon):
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.models')
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not emdadbot:
        ...
        emdadbot = self.env.ref('base.partner_root')
        emdadbot.active = True
        emdadbot.email = 'emdadbot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, emdadbot.email_formatted, f'groups@{self.alias_domain}',
                subject='emdadbot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, emdadbot)
        self.assertEqual(record4.message_ids[0].email_from, emdadbot.email_formatted)
        self.assertEqual(record4.message_follower_ids.partner_id, self.env['res.partner'],
                         'message_process: emdadbot -> no follower')
    ...
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.addons.mail.models.mail_thread', 'emdad.models.unlink', 'emdad.tests')
    ...
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.addons.mail.models.mail_thread', 'emdad.models')
    def test_message_route_alias_owner_author_notify(self):
        ...
        self.assertFalse(self.user_root.active, 'notification logic relies on emdadbot being archived')
        ...
        for email_to, test_user in itertools.product(email_tos, test_users):
            with self.subTest(test_user=test_user, email_to=email_to):
                ...
                self.assertEqual(new_messages.create_uid, self.user_root,
                                 'emdadbot should be creating the message')
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.models.unlink', 'emdad.addons.mail.models.mail_mail')
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.addons.mail.models.mail_mail', 'emdad.models.unlink')
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.addons.mail.models.mail_mail', 'emdad.models', 'emdad.sql_db')
    def test_message_process_alias_config_invalid_defaults(self):
        ...
        with self.mock_mail_gateway(), patch('emdad.addons.mail.models.mail_alias.Alias._alias_bounce_incoming_email',
        ...
        with self.assertRaises(Exception), patch('emdad.addons.mail.models.mail_alias.Alias._alias_bounce_incoming_email',
                                                 autospec=True) as _alias_bounce_incoming_email_mock:
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.models', 'emdad.tests')
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.models.unlink')
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.models.unlink', 'emdad.addons.mail.models.mail_mail', 'emdad.tests')
    def test_message_process_external_notification_reply(self):
        ...
        self.assertFalse(new_msg.is_internal, "Responses to messages sent by emdadbot should always be public.")
        ...
        new_msg = self.test_record.message_ids[0]
        self.assertTrue(new_msg.is_internal, "Responses to messages sent by anyone but emdadbot should keep"
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by emdad should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        emdad should update thread accordingly. Special case when the
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # emdad 10 update: compat mode has been removed and should not work anymore
    ...
    @mute_logger('emdad.addons.mail.models.mail_thread', 'emdad.addons.mail.models.mail_mail')
    ...
    def test_routing_loop_alias(self):
        ...
        with self.mock_mail_gateway():
            self.format_and_process(
                ...
                extra='References: <test-1337-loop-detection-bounce-email@emdad.com>',
            )
