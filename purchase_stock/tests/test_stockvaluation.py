...
import emdad
from emdad import fields, exceptions
from emdad.tests import Form
from emdad.tests.common import TransactionCase, tagged
from emdad.addons.account.tests.common import AccountTestInvoicingCommon
from emdad.tools import DEFAULT_SERVER_DATETIME_FORMAT
from emdad.addons.stock.tests.common import TestStockCommon
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        old_action_post = emdad.addons.account.models.account_move.AccountMove.action_post
        old_create = emdad.models.BaseModel.create
        ...
        post_patch = patch('emdad.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('emdad.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('emdad.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('emdad.fields.Date.context_today', _today),
            patch('emdad.fields.Datetime.now', _now),
        ]
