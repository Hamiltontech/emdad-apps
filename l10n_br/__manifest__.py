# Part of emdad. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.emdad.com/documentation/17.0/applications/finance/fiscal_localizations/brazil.html',
...
configure emdad in order to properly use Avatax and send the needed fiscal
