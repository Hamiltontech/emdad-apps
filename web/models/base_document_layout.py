...
from emdad.addons.base.models.ir_qweb_fields import nl2br
from emdad.tools import html2plaintext, is_html_empty
...
class BaseDocumentLayout(models.TransientModel):
    ...
    def _compile_scss(self, scss_source):
        ...
        Parameters are the same from emdad/addons/base/models/assetsbundle.py
