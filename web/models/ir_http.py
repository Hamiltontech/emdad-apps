...
from emdad.http import request, DEFAULT_MAX_CONTENT_LENGTH
from emdad.tools import ormcache, ustr
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = emdad.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.emdad.com/buy",
            "name": user.name,
            "username": user.login,
