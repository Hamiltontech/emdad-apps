...
from emdad.tools import topological_sort
from emdad.addons.base.models.assetsbundle import AssetsBundle, WebAsset


_logger = logging.getLogger(__name__)

class TestStaticInheritanceCommon(emdad.tests.TransactionCase):
    def setUp(self):
        super().setUp()
