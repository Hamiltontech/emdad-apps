...
(function () {
        ...
        define(name, deps, factory) {
            ...
            if (!this.factories.has(name)) {
                this.factories.set(name, {
                    deps,
                    fn: factory,
                    ignoreMissingDeps: globalThis.__emdadIgnoreMissingDependencies,
                });
                this.addJob(name);
    ...
    const emdad = globalThis.emdad;
    if (emdad.debug && !new URLSearchParams(location.search).has("debug")) {
        // remove debug mode if not explicitely set in url
        emdad.debug = "";
    }

    const loader = new ModuleLoader();
    emdad.define = loader.define.bind(loader);
