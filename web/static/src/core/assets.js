...
import { Component, xml, onWillStart, App } from "@emdad/owl";
...
assets.loadBundle = async function loadBundle(desc) {
    ...
    emdad.loader.checkAndReportErrors();
};
 ...
 */
export const templates = new DOMParser().parseFromString("<emdad/>", "text/xml");
/**
