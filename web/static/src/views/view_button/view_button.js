...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(emdad.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in emdadToBootstrapClasses) {
                    cls = emdadToBootstrapClasses[cls];
                }
                classNames.push(cls);
