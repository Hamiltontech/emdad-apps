...
import { Component, whenReady } from "@emdad/owl";
...
export async function startWebClient(Webclient) {
    ...
    await whenReady();
    const app = await mountComponent(Webclient, document.body, { name: "emdad Web Client" });
    const { env } = app;
    Component.env = env;
    ...
    // delete emdad.debug; // FIXME: some legacy code rely on this
    emdad.isReady = true;
}
