...
function emdadEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
emdadEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

emdadEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = Object.assign({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new emdadEvent(this, name, info);
