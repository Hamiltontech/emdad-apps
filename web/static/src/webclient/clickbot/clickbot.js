 ...
 */
function setup() {
    env = emdad.__WOWL_DEBUG__.root.env;
    ...
    menuIndex = 0;
    subMenuIndex = 0;
    isEnterprise = emdad.info && emdad.info.isEnterprise;
}
...
async function _clickEverywhere(xmlId) {
    ...
    console.log(`emdad flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
