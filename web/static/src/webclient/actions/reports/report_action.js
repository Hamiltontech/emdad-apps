...
import { Component, useRef, useSubEnv } from "@emdad/owl";
 ...
 * It uses a feature to automatically create links to other emdad pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
