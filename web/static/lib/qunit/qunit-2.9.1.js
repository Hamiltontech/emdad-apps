...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("emdadBeforeTestHook", "emdadAfterTestHook"); // emdad customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("emdadBeforeTestHook"); // emdad customization
