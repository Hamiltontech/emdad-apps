...
from emdad.tools import html_escape
from emdad.exceptions import AccessError
from emdad.addons.iap import jsonrpc
from emdad.addons.l10n_in_edi.models.account_edi_format import DEFAULT_IAP_ENDPOINT, DEFAULT_IAP_TEST_ENDPOINT
    ...
    def _l10n_in_edi_ewaybill_cancel_invoice(self, invoices):
        ...
        if response.get("error"):
            ...
            if "312" in error_codes:
                ...
                invoices.message_post(author_id=emdadbot.id, body=
                    Markup("%s<br/>%s:<br/>%s") %(
