...
from emdad import _, api, fields, models, modules, tools
from emdad.exceptions import UserError, ValidationError

from emdad.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from emdad.addons.account_edi_ubl_cii.models.account_edi_common import EAS_MAPPING
from emdad.addons.account_peppol.tools.demo_utils import handle_demo
...
class ResConfigSettings(models.TransientModel):
    ...
    def button_create_peppol_proxy_user(self):
        ...
        # but we need the field for future in case the user decided to migrate away from emdad
