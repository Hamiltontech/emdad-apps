...
from emdad.addons.payment_payumoney.controllers.main import PayUMoneyController
from emdad.addons.payment_payumoney.tests.common import PayumoneyCommon
...
class PayUMoneyTest(PayumoneyCommon, PaymentHttpCommon):
    ...
    @mute_logger('emdad.addons.payment_payumoney.controllers.main')
