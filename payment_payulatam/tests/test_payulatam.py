...
from emdad.addons.payment_payulatam.controllers.main import PayuLatamController
from emdad.addons.payment_payulatam.tests.common import PayULatamCommon
...
class PayULatamTest(PayULatamCommon, PaymentHttpCommon):
    ...
    @mute_logger('emdad.addons.payment_payulatam.controllers.main')
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(PayuLatamController._webhook_url)
        with patch(
            'emdad.addons.payment_payulatam.controllers.main.PayuLatamController'
