...
from emdad import api, fields, Command, models, _
from emdad.exceptions import UserError, ValidationError
from emdad.tools.misc import format_date
from emdad.tools import email_split, float_repr, float_round, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default emdad rate when the following change:
