...
import emdad
from emdad import api, models, exceptions, tools, http
from emdad.addons.base.models import ir_http
from emdad.addons.base.models.ir_http import RequestUID
...
from emdad.tools import config, ustr, pycompat
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except emdad.exceptions.MissingError:
