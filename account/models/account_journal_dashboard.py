...
from emdad import models, api, _, fields
from emdad.exceptions import UserError
from emdad.osv import expression
from emdad.release import version
from emdad.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from emdad.tools.misc import formatLang, format_date as emdad_format_date, get_lang
    ...
    def _get_json_activity_data(self):
        ...
        for activity in self.env.cr.dictfetchall():
            act = {
                ...
                'date': emdad_format_date(self.env, activity['date_deadline'])
            }
