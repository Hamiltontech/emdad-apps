...
from emdad import api, fields, models, _, Command
from emdad.addons.base.models.decimal_precision import DecimalPrecision
from emdad.addons.account.tools import format_structured_reference_iso
from emdad.exceptions import UserError, ValidationError, AccessError, RedirectWarning
...
class AccountMove(models.Model):
    ...
    quick_edit_total_amount = fields.Monetary(
        ...
        help='Use this field to encode the total amount of the invoice.\n'
             'emdad will automatically create one invoice line with default values to match it.',
    )
    ...
    def _get_invoice_reference_emdad_invoice(self):
        """ This computes the reference based on the emdad format.
    ...
    def _get_invoice_reference_emdad_partner(self):
        """ This computes the reference based on the emdad format.
    ...
    def _get_fields_to_copy_recurring_entries(self, values):
        ...
        values.update({
            ...
            'invoice_user_id': self.invoice_user_id.id,  # otherwise user would be emdadBot
        })
    ...
    def _disable_discount_precision(self):
        ...
        with patch('emdad.addons.base.models.decimal_precision.DecimalPrecision.precision_get', new=precision_get):
            yield
