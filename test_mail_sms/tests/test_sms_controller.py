...
from emdad.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from emdad.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("emdad.addons.base.models.ir_http")
    ...
    @mute_logger('emdad.addons.base.models.ir_http', 'emdad.addons.sms.controllers.main', 'emdad.http')
