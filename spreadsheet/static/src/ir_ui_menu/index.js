...
class BademdadLinkError extends EvaluationError {
    constructor(menuId) {
        super(
            _t("#LINK"),
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BademdadLinkError(xmlId);
            }
            return menu;
        }
        ...
        urlRegistry
            .add("emdadMenuIdLink", {
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BademdadLinkError(menuId);
                    }
                    return {
                        url,
                        label: _t(label),
                ...
                //     return new emdadMenuLinkCell(id, content, menuId, menuName, properties);
                // },
            })
            .add("emdadMenuXmlLink", {
                sequence: 66,
