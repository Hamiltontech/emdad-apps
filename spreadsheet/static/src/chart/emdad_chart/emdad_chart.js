...
import { AbstractChart, CommandResult } from "@emdad/o-spreadsheet";
 ...
 *
 * @typedef emdadChartDefinitionDataSource
 * @property {MetaData} metaData
 * @property {SearchParams} searchParams
 *
 */

export class emdadChart extends AbstractChart {
    /**
     * @param {emdadChartDefinition} definition
    ...
    static getDefinitionFromContextCreation() {
        throw new Error("It's not possible to convert an emdad chart to a native chart");
    }

    /**
     * @returns {emdadChartDefinitionDataSource}
     */
    getDefinitionForDataSource() {
        return {
            metaData: {
                ...this.metaData,
                mode: this.type.replace("emdad_", ""),
            },
