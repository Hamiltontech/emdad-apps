...
coreTypes.add("RENAME_emdad_PIVOT");
coreTypes.add("REMOVE_PIVOT");
coreTypes.add("RE_INSERT_PIVOT");
coreTypes.add("UPDATE_emdad_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_emdad_PIVOT_DOMAIN");
invalidateEvaluationCommands.add("REMOVE_PIVOT");
invalidateEvaluationCommands.add("INSERT_PIVOT");
invalidateEvaluationCommands.add("RENAME_emdad_PIVOT");

invalidateDependenciesCommands.add("UPDATE_emdad_PIVOT_DOMAIN");
invalidateDependenciesCommands.add("REMOVE_PIVOT");
invalidateDependenciesCommands.add("INSERT_PIVOT");
invalidateDependenciesCommands.add("RENAME_emdad_PIVOT");

invalidateCFEvaluationCommands.add("UPDATE_emdad_PIVOT_DOMAIN");
invalidateCFEvaluationCommands.add("REMOVE_PIVOT");
invalidateCFEvaluationCommands.add("INSERT_PIVOT");
invalidateCFEvaluationCommands.add("RENAME_emdad_PIVOT");
...
inverseCommandRegistry
    ...
    .add("RENAME_emdad_PIVOT", identity)
    .add("REMOVE_PIVOT", identity)
    .add("UPDATE_emdad_PIVOT_DOMAIN", identity)
