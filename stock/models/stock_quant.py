...
from emdad import _, api, fields, models, SUPERUSER_ID
from emdad.exceptions import UserError, ValidationError
from emdad.osv import expression
from emdad.tools import check_barcode_encoding, groupby, SQL
from emdad.tools.float_utils import float_compare, float_is_zero
