...
from emdad import SUPERUSER_ID, _, api, fields, models, registry
from emdad.exceptions import UserError
from emdad.osv import expression
from emdad.tools import float_compare, float_is_zero, html_escape
from emdad.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~emdad.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~emdad.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
