...
from emdad.tests import tagged, HttpCase

from emdad.addons.sale_loyalty.tests.common import TestSaleCouponNumbersCommon
from emdad.addons.website.tools import MockRequest
from emdad.addons.website_sale_loyalty.controllers.main import WebsiteSale
