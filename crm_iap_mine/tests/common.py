...
from emdad.addons.crm.models.crm_lead import Lead
from emdad.addons.crm_iap_mine.models.crm_iap_lead_mining_request import CRMLeadMiningRequest
from emdad.addons.iap.tests.common import MockIAPEnrich
