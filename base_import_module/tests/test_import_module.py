...
import emdad.tests
from emdad.tests import new_test_user


from unittest.mock import patch

from emdad.addons import __path__ as __addons_path__
from emdad.tools import mute_logger


@emdad.tests.tagged('post_install', '-at_install')
class TestImportModule(emdad.tests.TransactionCase):
    ...
    def test_import_zip_invalid_manifest(self):
        ...
        with mute_logger("emdad.addons.base_import_module.models.ir_module"):
    ...
    def test_import_zip_ignore_unexpected_data_extension(self):
        ...
        with self.assertLogs('emdad.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
...
class TestImportModuleHttp(TestImportModule, emdad.tests.HttpCase):
