...
from emdad import http, tools, _, release
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/emdad_ui_icons', type='http', auth='none', cors="*")
    def emdad_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/emdad_ui_icons/fonts/emdad_ui_icons.woff2').get_response()
