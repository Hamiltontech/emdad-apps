...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('emdad.tests', 'emdad.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_emdad(self):
        # set notifications to "handle in emdad" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in emdad" notification setting can
