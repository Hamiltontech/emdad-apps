...
from emdad.addons.calendar.models.calendar_attendee import Attendee
from emdad.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from emdad.tools import pycompat, html2plaintext, is_html_empty, single_email_re
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'emdad'
