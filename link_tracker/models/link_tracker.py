...
from emdad import tools, models, fields, api, _
from emdad.exceptions import UserError
from emdad.osv import expression
from emdad.addons.mail.tools import link_preview


class LinkTracker(models.Model):
    """ Link trackers allow users to wrap any URL into a short URL that can be
    tracked by emdad. Clicks are counter on each link. A tracker is linked to
