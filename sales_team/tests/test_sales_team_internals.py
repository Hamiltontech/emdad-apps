...
from emdad.addons.sales_team.tests.common import TestSalesMC
from emdad.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('emdad.sql_db'):
