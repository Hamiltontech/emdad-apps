...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('emdad.addons.mass_mailing.models.mailing', 'emdad.addons.mail.models.mail_mail', 'emdad.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_click(mailing, target_records[0], 'https://www.emdad.be')
        self.gateway_mail_click(mailing, target_records[2], 'https://www.emdad.be')
        self.gateway_mail_click(mailing, target_records[3], 'https://www.emdad.be')
