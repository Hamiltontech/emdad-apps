...
from emdad.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from emdad.addons.test_mass_mailing.tests.common import TestMassMailCommon
from emdad.tests import tagged
from emdad.tests.common import users
from emdad.tools import mute_logger, email_normalize
...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mailing, recipients,
            mail_links_info=[[
                ('url0', 'https://www.emdad.tz/my/%s' % record.name, True, {}),
                ...
                ('url7', 'mailto:test@emdad.com', False, {}),
        ...
        # simulate a click
        self.gateway_mail_click(mailing, recipients[0], 'https://www.emdad.be')
