...
from emdad import models, api, service
from emdad.tools.translate import _
from emdad.exceptions import UserError
from emdad.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "emdad " + service.common.exp_version()['server_version']
