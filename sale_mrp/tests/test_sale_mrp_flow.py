...
from emdad.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from emdad.tests import common, Form
from emdad.exceptions import UserError
from emdad.tools import mute_logger, float_compare
...
class TestSaleMrpFlow(ValuationReconciliationTestCommon):
    ...
    @mute_logger('emdad.tests.common.onchange')
