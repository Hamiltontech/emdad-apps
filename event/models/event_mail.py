...
from emdad.tools import exception_to_unicode
from emdad.tools.translate import _
from emdad.exceptions import MissingError, ValidationError
...
class EventMailScheduler(models.Model):
    ...
    configuration allowing to send emails on events since emdad 9. A cron exists
