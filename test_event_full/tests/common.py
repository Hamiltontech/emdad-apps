...
from emdad.addons.base.tests.common import HttpCaseWithUserDemo, HttpCaseWithUserPortal
from emdad.addons.event_crm.tests.common import EventCrmCase
...
from emdad.addons.website.tests.test_website_visitor import MockVisitor
