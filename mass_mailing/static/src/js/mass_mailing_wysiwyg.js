...
import { closestElement } from "@web_editor/js/editor/emdad-editor/src/emdadEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    setSnippetsMenuFolded(fold = true) {
        ...
        this.emdadEditor.toolbar = this.toolbarEl;
        this.emdadEditor.autohideToolbar = !!fold;
    ...
    async _createSnippetsMenuInstance(options={}) {
        ...
        const { MassMailingSnippetsMenu }  = await emdad.loader.modules.get('@mass_mailing/js/snippets.editor');
