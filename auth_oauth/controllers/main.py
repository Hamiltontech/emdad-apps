...
from emdad import api, http, SUPERUSER_ID, _
from emdad.exceptions import AccessDenied
from emdad.http import request, Response
from emdad import registry as registry_get
from emdad.tools.misc import clean_context

from emdad.addons.auth_signup.controllers.main import AuthSignupHome as Home
from emdad.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via emdad Account provider"""
